...
* [swpref.get](#swpref-get) retrieves a preference value
* [swpref.set](#swpref-set) sets a preference value
* [swpref.export](#swpref-export) saves swpref object into a file
* [swpref.import](#swpref-import) imports swpref object from file
 
Commands are methods which can be called without first creating a
preference object `swpref.command(....)`.
 
* [swpref.getpref](#swpref-getpref) retrieves a preference value
* [swpref.setpref](#swpref-setpref) sets a preference value
