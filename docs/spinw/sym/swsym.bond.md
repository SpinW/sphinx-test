...
: Basis vectors that define the lattice, used for checking the bond
  length of equivalent bonds, see [spinw.basisvector](#spinw-basisvector) for details.
...
[spinw.gencoupling](#spinw-gencoupling) \| [swsym.operator](#swsym-operator) \| [swsym.position](#swsym-position)
