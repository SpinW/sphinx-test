...
[spinw.plot](#spinw-plot) high level plot command.
...
: String, the name of the object. It can be used for grouping the
  object handles to enable easier search, see [swplot.findobj](#swplot-findobj) for
  details.
...
[swplot.color](#swplot-color) \| [swplot.add](#swplot-add)
