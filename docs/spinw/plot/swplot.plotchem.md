...
`'atom1'`
: Indices of atoms stored in [spinw.unit_cell](#spinw-unit-cell) for the center atom
  of the polyhedra or the first atom of the bonds. Can be also a
  string that identifies the atoms by their labels.
  
`'atom2'`
: Indices or label of the atoms stored in [spinw.unit_cell](#spinw-unit-cell). It
