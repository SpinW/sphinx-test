...
efficient than [spinw.optmagk](#spinw-optmagk) or [spinw.optmagsteep](#spinw-optmagsteep). However this
...
[spinw.optmagsteep](#spinw-optmagsteep) might be faster.
...
```{image} /_static/img/generated/spinw_optm_1.png
:alt: swplot.zoom(1.5)
```
...
to fix the `nTheta` value of [gm_planar](#gm-planar) during the optimisation to zero
...
[spinw](#spinw) \| [spinw.anneal](#spinw-anneal) \| [gm_spherical3d](#gm-spherical3d) \| [gm_planar](#gm-planar) \| [fminsearch]
