...
[spinw.lattice](#spinw-lattice) field.
...
: Defines the space group. Can have the following values:
  ...
  * **space group operators** matrix with dimensions 
  ...
  [spinw.gencoupling](#spinw-gencoupling) function will determine the equivalent bonds based on
  bond length.
...
[spinw](#spinw), [swsym.add](#swsym-add), [swsym.operator](#swsym-operator), [spinw.gencoupling](#spinw-gencoupling)
