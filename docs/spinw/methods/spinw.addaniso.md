...
```{image} /_static/img/generated/spinw_add_1.png
:alt: plot(cryst)
```
...
[spinw](#spinw), [spinw.single_ion](#spinw-single-ion), [spinw.addcoupling](#spinw-addcoupling), [spinw.addg](#spinw-addg) and [spinw.addmatrix](#spinw-addmatrix)
