...
```{image} /_static/img/generated/spinw_po_1.png
:alt: sw_plotspec(triSpec);
```
...
`'component'`
: See [sw_egrid](#sw-egrid) for the description of this parameter.
 
The function also accepts all parameters of [spinw.spinwave](#spinw-spinwave) with the
...
[spinw](#spinw) \| [spinw.spinwave](#spinw-spinwave) \| [spinw.optmagstr](#spinw-optmagstr) \| [sw_egrid](#sw-egrid)
