...
: Temperature, default value is taken from `obj.single_ion.T` and the
  unit is stored in [spinw.unit](#spinw-unit) with the default being K.
...
[spinw](#spinw) \| [spinw.spinwave](#spinw-spinwave) \| [spinw.genmagstr](#spinw-genmagstr) \| [spinw.temperature](#spinw-temperature)
