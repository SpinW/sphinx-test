...
output of [spinw.energy](#spinw-energy)." %}
...
: Function handle to measure TD quantities at the final temperature
  ...
  parameters). For comparison see the defaul function [sw_fstat](#sw-fstat).
...
the default function [sw_fstat](#sw-fstat) the following parameters are also
calculated:
...
[spinw](#spinw) \| [spinw.optmagstr](#spinw-optmagstr) \| [sw_fsub](#sw-fsub) \| [sw_fstat](#sw-fstat)
