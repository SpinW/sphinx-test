...
data file is described in [sw_readtable](#sw-readtable) with `sw_readspec` requires
...
the formatting of this string, see [sw_parstr](#sw-parstr). If the measured type of
...
[sw_egrid](#sw-egrid) \| [spinw.fitspec](#spinw-fitspec)
