...
```{image} /_static/img/tutorials/tutorial09/tutorial9_02.png
:alt: 
``` 
...
```{image} /_static/img/tutorials/tutorial09/tutorial9_03.png
:alt: 
``` 
...
```text
Ground state energy: -1.139 meV/spin.
```

```{image} /_static/img/tutorials/tutorial09/tutorial9_04.png
:alt: 
``` 
...
```{image} /_static/img/tutorials/tutorial09/tutorial9_05.png
:alt: 
``` 

### Powder spectrum

The flat mode that is the zero energy mode lifted by the DM interaction is well visible on the powder spectrum.
...
```{image} /_static/img/tutorials/tutorial09/tutorial9_06.png
:alt: 
``` 
