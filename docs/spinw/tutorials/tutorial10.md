...
```text
Warning: The x-ray scattering form factor for atom_1+ is undefined, constant 1
...
```{image} /_static/img/tutorials/tutorial10/tutorial10_02.png
:alt: 
``` 
...
```{image} /_static/img/tutorials/tutorial10/tutorial10_03.png
:alt: 
``` 
...
```text
Horace is not installed. Exiting....
```
